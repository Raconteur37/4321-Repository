...
public class DeactivateHandMenu_Distance : MonoBehaviour
{
    ...
    public float distanceThreshold = 0.5f; // distance to Deactivate hand ui in meters
    ...
    void CheckDistanceToDeactivateHandMenu()
    {
        ...
        {
            //Debug.Log("Deactivate hand menu - hand is less than threshold.");
        ...
        {
            // Debug to find correct distance
            //Debug.Log("Hand is out of range - less than threshold");
        }
